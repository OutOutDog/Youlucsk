...
public class ym2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ym2);
        // 地图初始化
        ...
        mBaiduMap.setOnMyLocationClickListener(new BaiduMap.OnMyLocationClickListener() {
            ...
            public boolean onMyLocationClick() {
                Toast.makeText(ym2.this,"点击定位图标", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        mBaiduMap.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                Toast.makeText(ym2.this,"点击Marker图标", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
