...
public class BaidDingw {

    /*-------------------------单例模式-------------------------------*/
    private static BaidDingw mLocationUtils;
public String a;
    private BaidDingw(Context context) {
        init(context);
    }

    public static BaidDingw getInstance(Context context) {
        if (mLocationUtils == null) {
            synchronized (BaidDingw.class) {
                if (mLocationUtils == null) {
                    mLocationUtils = new BaidDingw(context);
                }
            }
        }
